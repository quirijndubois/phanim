...
graph = Graph(width=0.03,color=(150,150,255))
graph2 = Graph(width=0.03,color=(255,150,150))
...
scr.wait(120)
scr.play(Destroy(graph),Destroy(axes,duration=120),Destroy(grid,duration=240))
