...
class Particles():
    def __init__(self,n=1000,lifetime=10,area=[[-5,5],[-5,5]],radius = 0.01,distribution = "even",trails=True,lineWidth=2,speed=5,maxspeed=1/4,fadingtime=2):
    ...
    def updatePosition(self,dt):
        for particle in self.particles:
            ...
            if particle.age > self.lifetime:
                ...
                # particle.lines = particle.trail.lines
